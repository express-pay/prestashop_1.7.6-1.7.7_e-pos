 ...
 * @since 1.0.0
 */
class ExpressPayEposNotificationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        $useSignature = Configuration::get('EXPRESSPAY_EPOS_USE_DIGITAL_SIGN_RECEIVE');
        //$this->log_info('postProcess','useSignature - '.(isset($useSignature) ? $useSignature : 'not used')) ;

        $secretWord   = Configuration::get('EXPRESSPAY_EPOS_RECEIVE_SECRET_WORD');
